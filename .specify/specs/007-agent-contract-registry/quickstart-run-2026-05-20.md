...
Generated: 2026-05-20T14:57:28.106Z

| Scenario | Evidence | Result |
| --- | --- | --- |
| Scenario 1 - Publish And Resolve A Contract | `contract=seeker.standard@1.0.0`<br>`status=published`<br>`event=published:initial_launch`<br>`audit_event_id=d3261537-c0d7-4916-a632-5aaf528bdd34`<br>`resolution=allow:contract_resolved` | PASS |
...
| Scenario 6 - Deprecate A Contract | `status=deprecated`<br>`deprecated_after=2026-05-21T00:00:00.000Z`<br>`event=deprecated:compliance_deprecation`<br>`audit_event_id=f2e16f3c-5f05-426c-9a81-2049dafa8bb2`<br>`post_cutoff_resolution=deny:contract_deprecated` | PASS |
