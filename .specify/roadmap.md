...
1. **Start F21 Seeker web surface:** run the Spec Kit specify → clarify/plan/tasks flow for `21-seeker-web-surface`, using PRD §3.4, §5.3, and §6.1 plus Parley A2A/publication notes before drafting the spec.
