...
| F08–F25 | ⏳ In progress | F08.5 Tool Surface & Dispatcher is complete and merged to `main` in PR #44; F09 Privacy Filter is complete and merged to `main` in PR #45; F10 Dossier Builder + Signer is complete on local branch `010-dossier-builder-signer` with quickstart evidence recorded. |
...
| F10 | Dossier builder + signer + per-audience projections + verifier | `10-dossier-builder-signer` | P0 | L — Complete (local branch `010-dossier-builder-signer`) | I.2; I.C.1; I.A; Parley §4.1.8, §15.4 |
...
- [x] **F10** Dossier builder + signer + per-audience projections + verifier _(local branch `010-dossier-builder-signer`; quickstart evidence recorded)_
