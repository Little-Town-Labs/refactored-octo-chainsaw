...
| F08–F25 | ⏳ In progress | F08.5 Tool Surface & Dispatcher is complete and merged to `main` in PR #44; F09 Privacy Filter is complete on local branch `009-privacy-filter` with quickstart evidence recorded. |
...
| F09 | Privacy filter module (no-model, sentinel-wrapped, CI-gated) | `09-privacy-filter` | P0 | L — Complete (local branch `009-privacy-filter`) | I.1; I.6; PRD §4.4, §9; Parley §9, §15.1, §15.2, §17.4–17.6 |
...
- [x] **F09** Privacy filter (no-model-invocation, sentinel-wrapped) _(local branch `009-privacy-filter`; quickstart evidence recorded)_
