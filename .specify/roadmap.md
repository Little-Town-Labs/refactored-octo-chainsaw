...
| ID | Feature | Slug | Priority | Complexity | Constitution refs |
|----|---------|------|----------|------------|-------------------|
| F21 | Seeker web surface (landing + Clerk profile + agents.md/llms.txt + A2A cards) | `21-seeker-web-surface` | P0 | M — Active (`021-seeker-web-surface`) | III (dual-audience landing page); II (A2A agent cards) |
...
### Stage 7 checklist
- [ ] **F21** Seeker web surface _(implemented on `021-seeker-web-surface`; quickstart evidence recorded; PR pending)_
- [ ] **F22** Employer admin console
...
1. **Publish F21 PR:** review final diff, commit, push `021-seeker-web-surface`, open PR, and verify checks/mergeability.
