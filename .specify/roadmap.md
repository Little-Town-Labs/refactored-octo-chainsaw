...
1. **Start F22 Employer admin console:** run the Spec Kit specify → clarify/plan/tasks flow for `22-employer-admin-console`, reading PRD employer/admin sections, identity/admin access requirements, and existing operator console patterns before drafting the spec.
