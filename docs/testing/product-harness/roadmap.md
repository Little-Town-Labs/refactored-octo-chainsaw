...
| PTH14 Canary workflow hardening | In progress | Active Spec Kit slice: enforce required env/secrets and wire canary workflows to use Neon persistence, Browserbase, and durable artifact storage when running against preview/prod. |
