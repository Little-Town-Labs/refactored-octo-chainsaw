...
| PTH15 Eval trend and cost monitoring | In progress | Active Spec Kit slice: persist persona eval cost, latency, outcome, and drift trends while keeping evals informational. |
