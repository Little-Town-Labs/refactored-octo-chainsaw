...
| PTH12 Durable artifact storage | In progress | Active Spec Kit slice: persist report/browser/trace/video/transcript blobs outside GitHub artifact retention while storing metadata refs in Neon. |
